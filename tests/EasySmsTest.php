...
namespace Zzy\LaravelSms\Tests;
...
class EasySmsTest extends TestCase
{
    public function testGateway()
    {
        ...
        $this->expectExceptionMessage('Class "Zzy\LaravelSms\Gateways\NotExistsGatewayNameGateway" is a invalid easy-sms gateway.');
    ...
    public function testGatewayNameConflicts()
    {
        ...
        $this->expectExceptionMessage('Class "Zzy\LaravelSms\Tests\DummyGatewayNotImplementsGatewayInterface" is a invalid easy-sms gateway.');
    ...
    public function testGatewayWithDefaultSetting()
    {
        ...
        $this->expectExceptionMessage(
            sprintf(
                'Class "Zzy\LaravelSms\Gateways\%sGateway" is a invalid easy-sms gateway.',
